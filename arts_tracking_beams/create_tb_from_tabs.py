...
def main():
    ...
    # input/output files
    # input_file = 'X:/PSRJ2215+1538_202000409_CB14/fits/ARTS200409008_CB14_TAB{tab:02d}.fits'
    input_file = 'F:/Leon/Desktop/python/tracking_beams_testing/data/fits/ARTS200409008_CB14_TAB{tab:02d}.fits'
    ...
    #for sub_subint in tqdm.tqdm(range(n)):
        ...
        try:
            ...
            tabs = tab_indices[-1]
        # extract data
        reader.read_tabs_to_buffer(subint, nsubint_to_read, tabs, output_handle['SUBINT'])
